...
`,pc=[{id:1,category:"제품문의",question:"[공통] 제품 관련 문의는 어디로 하면 되나요?",answer:`제품 관련 문의는 시디즈 챗봇 혹은 컨택센터를 통해 [상담원 연결]을 선택해주시면 친절하게 안내해 드리겠습니다.
...
`,vv=()=>{const e=z(),t=R(),{authed:r}=O(p=>p.auth);f.useEffect(()=>{e(r?"/":"/login")},[r]);const o=()=>{e("/join")},[s,i]=f.useState({userid:"",password:""}),{userid:c,password:l}=s,a=p=>{const{name:d,value:m}=p.target;i({...s,[d]:m})},u=p=>{p.preventDefault(),!(!c||!l)&&(t(ny(s)),i({userid:"",password:""}))};return n.jsxs(xv,{onSubmit:u,children:[n.jsxs("p",{className:"id",children:[n.jsx("label",{htmlFor:"",children:"아이디"}),n.jsx("input",{type:"text",name:"userid",value:c,onChange:a})]}),n.jsxs("p",{className:"pwd",children:[n.jsx("label",{htmlFor:"",children:"비밀번호"}),n.jsx("input",{type:"password",name:"password",value:l,onChange:a})]}),n.jsxs("p",{className:"btn",children:[n.jsx("button",{type:"submit",children:"로그인"}),n.jsx("button",{onClick:o,children:"회원가입"})]})]})},kv=()=>(f.useEffect(()=>{window.scrollTo({top:0})},[]),n.jsxs(gv,{children:[n.jsxs("ul",{children:[n.jsx("li",{children:n.jsx(C,{to:"/",children:"HOME"})}),n.jsx("li",{className:"on",children:"로그인"}),n.jsx("li",{children:n.jsx(C,{to:"/join",children:"회원가입"})})]}),n.jsxs("div",{className:"subInner",children:[n.jsx("h2",{children:"LOGIN"}),n.jsx(vv,{})]})]})),wv=[`시디즈 쇼핑몰 이용약관
...
시행일자 : 2023.11.16
 ...
 `],Nv=()=>{const e=R(),t=z(),[r,o]=f.useState({all:!1,terms:!1,personal:!1,provision:!1,marketing:!1}),{all:s,terms:i,personal:c,provision:l,marketing:a}=r,u=N=>{const{name:b,checked:S}=N.target;o({...r,[b]:S})},p=N=>{const{checked:b}=N.target;o({all:b,terms:b,personal:b,provision:b,marketing:b})},[d,m]=f.useState({userid:"",password:"",name:"",tel:"",email:""}),x=N=>{const{name:b,value:S}=N.target;m({...d,[b]:S})},{userid:v,password:y,name:j,tel:h,email:g}=d,k=()=>{e(sy({userid:v}))},w=N=>{if(N.preventDefault(),!i||!c||!l){alert("필수 약관에 동의해 주세요.");return}!v||!y||!j||!h||!g||(e(oy(d)),m({userid:"",password:"",name:"",tel:"",email:""}),alert("회원가입이 완료되었습니다."),t("/login"))};return console.log(i),n.jsxs(yv,{onSubmit:w,children:[n.jsxs("div",{className:"policy",children:[n.jsx("h3",{children:"약관동의"}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"all",checked:s,onChange:p}),n.jsx("label",{htmlFor:"all",children:"전체 동의"})]}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"terms",checked:i,onChange:u}),n.jsx("label",{htmlFor:"terms",children:"이용약관 (필수)"})]}),n.jsxs("p",{className:"terms",children:[n.jsxs("span",{children:[n.jsx("input",{type:"checkbox",name:"personal",checked:c,onChange:u}),n.jsx("label",{htmlFor:"personal",children:"개인정보 수집 및 이용 동의 (필수)"})]}),n.jsx("textarea",{readOnly:!0,children:wv})]}),n.jsxs("p",{className:"terms",children:[n.jsxs("span",{children:[n.jsx("input",{type:"checkbox",name:"provision",checked:l,onChange:u}),n.jsx("label",{htmlFor:"provision",children:"개인정보 제 3자 제공 동의 (필수)"})]}),n.jsx("textarea",{readOnly:!0,children:Cv})]}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"marketing",checked:a,onChange:u}),n.jsx("label",{htmlFor:"marketing",children:"개인정보 수집 및 이용 동의 (선택)"})]})]}),n.jsxs("div",{className:"input",children:[n.jsx("h3",{children:"회원정보 입력"}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"userid",children:"아이디"}),n.jsx("input",{type:"text",name:"userid",value:v,onChange:x}),n.jsx("button",{onClick:k,children:"중복확인"}),n.jsx("em",{children:"3~15자의 영문 또는 숫자를 공백없이 입력해주세요."})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"비밀번호"}),n.jsx("input",{type:"password",name:"password",value:y,onChange:x}),n.jsx("em",{children:"공백없는 8~15자의 영문/숫자/특수문자를 조합하여 입력해야 합니다."})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"이름"}),n.jsx("input",{type:"text",name:"name",value:j,onChange:x})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"휴대전화"}),n.jsx("input",{type:"text",name:"tel",value:h,onChange:x})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"이메일"}),n.jsx("input",{type:"email",name:"email",value:g,onChange:x}),n.jsx("em",{children:"마케팅 동의를 하신 분은 꼭 기입해주세요."})]})]}),n.jsxs("p",{className:"btn",children:[n.jsx("button",{type:"submit",children:"가입하기"}),n.jsx("button",{onClick:()=>{alert("가입이 취소되었습니다."),t("/")},children:"가입취소"})]})]})},pd=()=>(f.useEffect(()=>{window.scrollTo({top:0})},[]),n.jsxs(jv,{children:[n.jsxs("ul",{children:[n.jsx("li",{children:n.jsx(C,{to:"/",children:"HOME"})}),n.jsx("li",{children:n.jsx(C,{to:"/login",children:"로그인"})}),n.jsx("li",{className:"on",children:"회원가입"})]}),n.jsxs("div",{className:"subInner",children:[n.jsx("h2",{children:"회원가입"}),n.jsx(Nv,{})]})]})),Sv=A.div`
    .subInner {
        width: 1200px;
        padding: 50px 0 100px;
    }
...
`,Pv=()=>n.jsx(zv,{children:n.jsx("td",{colSpan:"6",className:"empty",children:"장바구니에 담긴 품목이 없습니다."})}),Dv=()=>n.jsxs(Ov,{children:[n.jsx("li",{children:n.jsx(C,{to:"/",children:"HOME"})}),n.jsx("li",{className:"on",children:"장바구니"})]}),Lv={carts:[],cartTotal:0},Pm=Co({name:"cart",initialState:Lv,reducers:{addCart:(e,t)=>{const{name:r,code:o,selectedColor:s,selectedColorCode:i,price:c,quantity:l}=t.payload,a={id:e.carts.length>0?e.carts[e.carts.length-1].id+1:1,name:r,code:o,selectedColor:s,selectedColorCode:i,price:c,quantity:l};if(e.carts.find(u=>u.name===a.name&&u.selectedColor===a.selectedColor)){alert("이미 장바구니에 추가된 상품입니다.");return}e.carts.push(a),alert("장바구니에 추가되었습니다.")},removeCart:(e,t)=>{e.carts=e.carts.filter(r=>r.id!==t.payload)},removeAll:e=>{e.carts=[]},totalCart:e=>{e.cartTotal=e.carts.reduce((t,r)=>t+Number(r.price*r.quantity),0)},updateQuantity:(e,t)=>{const{id:r,quantity:o}=t.payload,s=e.carts.find(i=>i.id===r);s&&(s.quantity=o)},buyItem:(e,t)=>{if(e.carts.length===0){alert("장바구니가 비어있습니다.");return}else alert("주문이 완료되었습니다."),e.carts=[]}}}),{addCart:L,removeCart:Mv,totalCart:Fv,removeAll:Uv,updateQuantity:Bv,buyItem:Wv}=Pm.actions,Qv=Pm.reducer,Kv=({cart:e})=>{const{id:t,name:r,price:o,selectedColor:s,selectedColorCode:i,code:c,quantity:l}=e,a=R(),u=d=>{const m=Number(d.target.value);a(Bv({id:t,quantity:m}))},p=d=>{d.preventDefault()};return n.jsxs(Av,{children:[n.jsxs("td",{className:"product",children:[n.jsx("img",{src:`./images/cart/${c}/${i}.png`,alt:r}),r]}),n.jsx("td",{children:s}),n.jsxs("td",{children:[o.toLocaleString(),"원"]}),n.jsx("td",{children:n.jsx("input",{type:"number",value:l,min:1,max:99,onKeyDown:p,onChange:u})}),n.jsxs("td",{children:[Number(o*l).toLocaleString(),"원"]}),n.jsx("td",{children:n.jsx("button",{onClick:()=>a(Mv(t)),children:"삭제"})})]})},Hv=()=>{const{carts:e,cartTotal:t}=O(s=>s.cart),r=R(),o=z();return f.useEffect(()=>{r(Fv())},[e]),console.log(e),n.jsxs(Rv,{children:[n.jsx(Dv,{}),n.jsxs("div",{className:"subInner",children:[n.jsx("h2",{children:"장바구니"}),n.jsxs("table",{children:[n.jsxs("colgroup",{children:[n.jsx("col",{className:"name"}),n.jsx("col",{className:"color"}),n.jsx("col",{className:"price"}),n.jsx("col",{className:"count"}),n.jsx("col",{className:"totalPrice"}),n.jsx("col",{className:"del"})]}),n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"제품정보"}),n.jsx("th",{children:"색상"}),n.jsx("th",{children:"판매가격"}),n.jsx("th",{children:"수량"}),n.jsx("th",{children:"주문금액"}),n.jsx("th",{})]})}),n.jsx("tbody",{children:e.length===0?n.jsx(Pv,{}):n.jsx(n.Fragment,{children:e.map(s=>n.jsx(Kv,{cart:s},s.id))})}),n.jsx("tfoot",{children:n.jsxs("tr",{children:[n.jsx("th",{colSpan:4,children:"총 결제금액"}),n.jsxs("th",{colSpan:2,children:[t.toLocaleString(),"원"]})]})})]}),n.jsxs("p",{className:"cart-button",children:[n.jsx("button",{onClick:()=>{o("/")},children:"계속 쇼핑하기"}),n.jsx("button",{onClick:()=>r(Uv()),children:"전체상품 삭제하기"}),n.jsx("button",{onClick:()=>r(Wv()),children:"상품 주문하기"})]})]})]})},Vv=A.div`
    padding: 10px 0;
    padding-left: 250px;
    border-bottom: 2px solid #dcdcdc;
    display: flex;
