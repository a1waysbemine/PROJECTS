...
시행일자 : 2023.11.16
 ...
 `],Cv=()=>{const e=R(),t=z(),[r,o]=f.useState({all:!1,terms:!1,personal:!1,provision:!1,marketing:!1}),{all:s,terms:i,personal:c,provision:l,marketing:a}=r,u=N=>{const{name:b,checked:S}=N.target;o({...r,[b]:S})},p=N=>{const{checked:b}=N.target;o({all:b,terms:b,personal:b,provision:b,marketing:b})},[d,m]=f.useState({userid:"",password:"",name:"",tel:"",email:""}),x=N=>{const{name:b,value:S}=N.target;m({...d,[b]:S})},{userid:v,password:y,name:j,tel:h,email:g}=d,k=()=>{e(cy({userid:v}))},w=N=>{if(N.preventDefault(),!i||!c||!l){alert("필수 약관에 동의해 주세요.");return}!v||!y||!j||!h||!g||(e(ly(d)),m({userid:"",password:"",name:"",tel:"",email:""}),alert("회원가입이 완료되었습니다."),t("/login"))};return console.log(i),n.jsxs(jv,{onSubmit:w,children:[n.jsxs("div",{className:"policy",children:[n.jsx("h3",{children:"약관동의"}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"all",checked:s,onChange:p}),n.jsx("label",{htmlFor:"all",children:"전체 동의"})]}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"terms",checked:i,onChange:u}),n.jsx("label",{htmlFor:"terms",children:"이용약관 (필수)"})]}),n.jsxs("p",{className:"terms",children:[n.jsxs("span",{children:[n.jsx("input",{type:"checkbox",name:"personal",checked:c,onChange:u}),n.jsx("label",{htmlFor:"personal",children:"개인정보 수집 및 이용 동의 (필수)"})]}),n.jsx("textarea",{readOnly:!0,children:kv})]}),n.jsxs("p",{className:"terms",children:[n.jsxs("span",{children:[n.jsx("input",{type:"checkbox",name:"provision",checked:l,onChange:u}),n.jsx("label",{htmlFor:"provision",children:"개인정보 제 3자 제공 동의 (필수)"})]}),n.jsx("textarea",{readOnly:!0,children:wv})]}),n.jsxs("p",{children:[n.jsx("input",{type:"checkbox",name:"marketing",checked:a,onChange:u}),n.jsx("label",{htmlFor:"marketing",children:"개인정보 수집 및 이용 동의 (선택)"})]})]}),n.jsxs("div",{className:"input",children:[n.jsx("h3",{children:"회원정보 입력"}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"userid",children:"아이디"}),n.jsx("input",{type:"text",name:"userid",value:v,onChange:x}),n.jsx("button",{onClick:k,children:"중복확인"}),n.jsx("em",{children:"3~15자의 영문 또는 숫자를 공백없이 입력해주세요."})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"비밀번호"}),n.jsx("input",{type:"password",name:"password",value:y,onChange:x}),n.jsx("em",{children:"공백없는 8~15자의 영문/숫자/특수문자를 조합하여 입력해야 합니다."})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"이름"}),n.jsx("input",{type:"text",name:"name",value:j,onChange:x})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"휴대전화"}),n.jsx("input",{type:"text",name:"tel",value:h,onChange:x})]}),n.jsxs("p",{children:[n.jsx("label",{htmlFor:"",children:"이메일"}),n.jsx("input",{type:"email",name:"email",value:g,onChange:x}),n.jsx("em",{children:"마케팅 동의를 하신 분은 꼭 기입해주세요."})]})]}),n.jsxs("p",{className:"btn",children:[n.jsx("button",{type:"submit",children:"가입하기"}),n.jsx("button",{onClick:()=>{alert("가입이 취소되었습니다."),t("/")},children:"가입취소"})]})]})},md=()=>(f.useEffect(()=>{window.scrollTo({top:0})},[]),n.jsxs(xv,{children:[n.jsxs("ul",{children:[n.jsx("li",{children:n.jsx(C,{to:"/",children:"HOME"})}),n.jsx("li",{children:n.jsx(C,{to:"/login",children:"로그인"})}),n.jsx("li",{className:"on",children:"회원가입"})]}),n.jsxs("div",{className:"subInner",children:[n.jsx("h2",{children:"회원가입"}),n.jsx(Cv,{})]})]})),Nv=A.div`
    .subInner {
        width: 1200px;
        padding: 50px 0 100px;
    }
