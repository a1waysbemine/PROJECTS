    ...
    return (
        <JoinFormWrap onSubmit={onSubmit}>
            <div className="policy">
                ...
                <p>
                    <input type="checkbox" name="terms" checked={terms} onChange={changeCheck} />
                ...
                <p className="terms">
                    ...
                    <textarea readOnly>{terms_of_use}</textarea>
                </p>
                <p className="terms">
                    <span>
                        <input
                    ...
                    <textarea readOnly>{personal_info}</textarea>
                </p>
                <p>
                    <input
                        type="checkbox"
            ...
            <div className="input">
                ...
                <p>
                    ...
                    />
                    <em>공백없는 8~15자의 영문/숫자/특수문자를 조합하여 입력해야 합니다.</em>
                </p>
                <p>
