...
import MoltiList from "./MoltiList";
  ...
  return (
    <ProductsWrap>
      <ul className="subMenu">
        ...
        <li className="on">molti</li>
      </ul>
      <div className="subInner">
        <div>
          <img src="./images/products/forkids/moltiBig.jpg" alt="molti" />
        </div>
        <SortWrap>
          <ul>
            <li
        ...
        <MoltiList molti={sortedData()} />
      </div>
    </ProductsWrap>
  );
};

export default Molti;
