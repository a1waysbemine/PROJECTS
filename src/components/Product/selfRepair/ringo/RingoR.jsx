...
import RingoRList from './RingoRList';
    ...
    return (
        <ProductsWrap>
            ...
            <div className="subInner">
                <div>
                    <img src="../images/products/selfrepair/ringoBig.jpg" alt="ringorepair" />
                </div>
                <SortWrap>
                    <ul>
                        <li
                ...
                <RingoRList ringoRepair={sortedData()} />
            </div>
        </ProductsWrap>
    );
};

export default RingoR;
