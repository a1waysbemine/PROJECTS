...
import T50AirList from './T50AirList';
    ...
    return (
        <ProductsWrap>
            <ul className="subMenu">
                ...
                <li className="on">T50 AIR</li>
            </ul>
            <div className="subInner">
                <div>
                    <img src="../images/products/work/t50_airBig.jpg" alt="t50_air" />
                </div>
                <SortWrap>
                    <ul>
                        <li
                ...
                <T50AirList t50air={sortedData()} />
            </div>
        </ProductsWrap>
    );
};

export default T50Air;
